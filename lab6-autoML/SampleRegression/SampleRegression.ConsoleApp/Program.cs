...
namespace SampleRegression.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"C:\Projects\MLNet.Class\lab6-autoML\bike_rental.csv";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Single Prediction --> Actual value: {sampleData.Cnt} | Predicted value: {predictionResult.Score}");
